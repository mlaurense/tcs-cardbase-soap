...
/**
 * This class stands for Refill ServiceType
 * @subpackage Services
 */
class Refill extends AbstractSoapClientBase
{
    /**
    ...
    /**
     * Method to call the operation originally named Refill
     ...
     * @param \StructType\RefillRequest $parameters
     * @return \StructType\RefillResponse|bool
     */
    public function Refill(\StructType\RefillRequest $parameters)
    {
        try {
            $this->setResult($resultRefill = $this->getSoapClient()->__soapCall('Refill', [
                $parameters,
            ], [], [], $this->outputHeaders));
     ...
     * @return \StructType\RefillResponse
     */
