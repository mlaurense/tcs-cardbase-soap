...
/**
 * This class stands for Suspend ServiceType
 * @subpackage Services
 */
class Suspend extends AbstractSoapClientBase
{
    /**
    ...
    /**
     * Method to call the operation originally named Suspend
     ...
     * @param \StructType\SuspendRequest $parameters
     * @return \StructType\SuspendResponse|bool
     */
    public function Suspend(\StructType\SuspendRequest $parameters)
    {
        try {
            $this->setResult($resultSuspend = $this->getSoapClient()->__soapCall('Suspend', [
                $parameters,
            ], [], [], $this->outputHeaders));
     ...
     * @return \StructType\SuspendResponse
     */
