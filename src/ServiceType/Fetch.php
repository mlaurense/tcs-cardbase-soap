...
class Fetch extends AbstractSoapClientBase
{
    ...
    /**
     * Method to call the operation originally named Fetch
     ...
     * @param \StructType\FetchRequest $parameters
     * @return \StructType\FetchResponse|bool
     */
    public function Fetch(\StructType\FetchRequest $parameters)
    {
        try {
            $this->setResult($resultFetch = $this->getSoapClient()->__soapCall('Fetch', [
                $parameters,
            ], [], [], $this->outputHeaders));
