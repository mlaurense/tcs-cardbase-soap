...
/**
 * This class stands for UnsuspendResponse StructType
 * @subpackage Structs
 */
class UnsuspendResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for UnsuspendResponse
     * @uses UnsuspendResponse::setCard()
     * @uses UnsuspendResponse::setTransactionID()
