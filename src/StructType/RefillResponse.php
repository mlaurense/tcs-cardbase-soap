...
/**
 * This class stands for RefillResponse StructType
 * @subpackage Structs
 */
class RefillResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for RefillResponse
     * @uses RefillResponse::setCard()
     * @uses RefillResponse::setTransactionID()
