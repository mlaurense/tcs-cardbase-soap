...
/**
 * This class stands for RollbackResponse StructType
 * @subpackage Structs
 */
class RollbackResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for RollbackResponse
     * @uses RollbackResponse::setCard()
     * @uses RollbackResponse::setTransactionID()
