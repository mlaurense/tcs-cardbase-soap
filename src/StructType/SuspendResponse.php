...
/**
 * This class stands for SuspendResponse StructType
 * @subpackage Structs
 */
class SuspendResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for SuspendResponse
     * @uses SuspendResponse::setCard()
     * @uses SuspendResponse::setTransactionID()
