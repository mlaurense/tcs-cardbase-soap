...
/**
 * This class stands for CardInfoResponse StructType
 * @subpackage Structs
 */
class CardInfoResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for CardInfoResponse
     * @uses CardInfoResponse::setCard()
