...
/**
 * This class stands for VoidActivateResponse StructType
 * @subpackage Structs
 */
class VoidActivateResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for VoidActivateResponse
     * @uses VoidActivateResponse::setCard()
     * @uses VoidActivateResponse::setTransactionID()
