...
/**
 * This class stands for UnsuspendRequest StructType
 * @subpackage Structs
 */
class UnsuspendRequest extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for UnsuspendRequest
     * @uses UnsuspendRequest::setCard()
     * @uses UnsuspendRequest::setRemark()
     * @uses UnsuspendRequest::setTransactionTag()
     ...
     * Set Card value
     * @param \StructType\CardIdentifier $card
     * @return \StructType\UnsuspendRequest
     */
