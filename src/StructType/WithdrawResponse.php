...
/**
 * This class stands for WithdrawResponse StructType
 * @subpackage Structs
 */
class WithdrawResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for WithdrawResponse
     * @uses WithdrawResponse::setCard()
     * @uses WithdrawResponse::setTransactionID()
