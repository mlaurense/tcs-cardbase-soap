...
/**
 * This class stands for ChangeProductResponse StructType
 * @subpackage Structs
 */
class ChangeProductResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for ChangeProductResponse
     * @uses ChangeProductResponse::setCard()
     * @uses ChangeProductResponse::setTransactionID()
     ...
     * @param \StructType\Card $card
     * @return \StructType\ChangeProductResponse
     */
