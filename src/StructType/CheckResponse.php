...
/**
 * This class stands for CheckResponse StructType
 * @subpackage Structs
 */
class CheckResponse extends AbstractStructBase
{
    /**
     * The Card
    ...
    /**
     * Constructor method for CheckResponse
     * @uses CheckResponse::setCard()
